export const dict = {
  ...
  "settings.mode.description": "Choose how OpenCode behaves in this workspace. Changing the mode reloads the instance.",
  "settings.mode.section.workspace": "Workspace",
  "settings.mode.row.workspace.title": "Applies to",
  "settings.mode.row.workspace.description": "Current workspace: {{workspace}}",
  "settings.mode.row.workspace.description.none": "Open a workspace to configure mode",
  "settings.mode.row.mode.title": "Product mode",
  "settings.mode.row.mode.description": "Switching mode controls which plugins are loaded (and may change dispatch behavior).",
  "settings.mode.placeholder.noWorkspace": "Open a workspace to select a mode",
  "settings.mode.placeholder.unset": "Not set (keep current behavior)",
  "settings.mode.toast.updateFailed.title": "Failed to update mode",

  "settings.mode.option.base.title": "Base",
  "settings.mode.option.base.description": "No industry plugins; OpenCode handles chat & dispatch.",
  "settings.mode.option.programming.title": "Programming",
  "settings.mode.option.programming.description": "Enable oh-my-opencode; plugin takes over multi-session dispatch by default.",
  "settings.mode.option.legal.title": "Legal",
  "settings.mode.option.legal.description": "Enable legal plugins (e.g. oh-my-legal); plugin takes over dispatch by default.",
  "settings.mode.option.marxism.title": "Marxism analysis",
  "settings.mode.option.marxism.description": "Enable Marxism analysis plugins (future, e.g. oh-my-marxism).",
