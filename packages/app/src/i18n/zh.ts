...
export const dict = {
  ...
  "settings.mode.description": "选择 OpenCode 在当前工作区的运行模式；切换后会重新加载实例。",
  "settings.mode.section.workspace": "工作区",
  "settings.mode.row.workspace.title": "作用范围",
  "settings.mode.row.workspace.description": "当前工作区：{{workspace}}",
  "settings.mode.row.workspace.description.none": "请先打开一个工作区再设置模式",
  "settings.mode.row.mode.title": "产品模式",
  "settings.mode.row.mode.description": "切换模式会影响插件加载（以及多会话派工策略）。",
  "settings.mode.placeholder.noWorkspace": "请先打开工作区再选择模式",
  "settings.mode.placeholder.unset": "未设置（保持现状）",
  "settings.mode.toast.updateFailed.title": "模式更新失败",

  "settings.mode.option.base.title": "基础模式",
  "settings.mode.option.base.description": "不启用行业插件；由 OpenCode 基座负责对话与派工。",
  "settings.mode.option.programming.title": "编程开发模式",
  "settings.mode.option.programming.description": "启用 oh-my-opencode；多会话派工默认由插件接管（基座只提示）。",
  "settings.mode.option.legal.title": "律师助理模式",
  "settings.mode.option.legal.description": "启用律师插件（如 oh-my-legal）；多会话派工默认由插件接管（基座只提示）。",
  "settings.mode.option.marxism.title": "马哲分析模式",
  "settings.mode.option.marxism.description": "启用马哲分析插件（未来如 oh-my-marxism）；多会话派工默认由插件接管（基座只提示）。",
